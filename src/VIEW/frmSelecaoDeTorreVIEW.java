 ...
 */
public class frmSelecaoDeTorreVIEW extends javax.swing.JFrame {

    /**
     * Creates new form frmSelecaoDeTorreVIEW
     */
    public frmSelecaoDeTorreVIEW() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Escolha o nivel desejado:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSelecaoDeTorreVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSelecaoDeTorreVIEW().setVisible(true);
            }
        });
    }
